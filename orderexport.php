...
class Orderexport extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('order export');
        $this->description = $this->l('order export to csv file');
    ...
    public function getContent()
    {
        ...
        return $this->html . $helper;
        if (((bool)Tools::isSubmit('submitOrderexportModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitOrderexportModule';
